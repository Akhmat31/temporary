  ...
  <section className="z-50 relative w-full h-[720px] overflow-hidden">
    <div className="relative h-[720px] rounded-b-[50px] shadow-lg overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full z-20 px-16 py-6 flex items-center justify-between">
        ...
        <Navbar />
        <div className="border border-gray-400 px-4 py-2 rounded-full text-sm">
          <i className="text-white bi bi-whatsapp"></i>0822 77777 911
        </div>
      </div>
      ...
      <div className="absolute left-20 top-[300px] z-20 max-w-xs">
        ...
        <button className="mt-4 bg-[#003D35] px-4 py-2 rounded-full text-xs">
          Tentang PUI
        </button>
      </div>
      <div className="absolute right-24 top-[260px] z-20 flex flex-col gap-4">
        <div
          className="flex items-center gap-2 bg-[#243F29] border-2 rounded-[10px] border-[#5C5E3D] px-4 py-2 text-xs shadow">
          <img className="w-[60px]" src="/assets/img/logo-ojk.png" />
          Terdaftar & diawasi OJK
        </div>
        <div className="-ml-20">
          <div
            className="inline-flex mt-10 items-center gap-2 bg-[#243F29] border-2 rounded-[10px] border-[#5C5E3D] px-4 py-2 text-xs shadow">
            <img className="w-[30px]" src="/assets/img/icon-chart.png" />
            Valuasi Aset Tinggi
          </div>
        </div>
        <div
          className="flex items-center mt-14 gap-2 bg-[#243F29] border-2 rounded-[10px] border-[#5C5E3D] px-4 py-2 text-xs shadow">
      ...
      <div className="absolute -mb-10 bottom-[110px] left-1/2 -translate-x-1/2 z-20">
        <button className="bg-[#D4AA6A] text-black px-8 py-3 rounded-md text-sm font-semibold shadow-xl">
